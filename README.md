...
PL/SQL: As we all know that SQL stands for structure query language and its basically not a procedural language but the PL/SQL adds this beautiful feature so that this drawback gets removed.
